...
=head1 SYNOPSIS
  ...
  # DataMembers -- Class builder helper...
  {
    ...
    use Class::STL::ClassMembers (
        ...
        Class::STL::ClassMembers::FunctionMember::New->new(), # produce class new() function
    ); 
  }
...
This I<helper> class can be used to generate code for various basic class functions. This module requires an import list consisting of target data member names, I<Class::STL::ClassMembers::DataMember>, or I<Class::STL::ClassMembers::FunctionMember> objects. When using I<ClassMembers> B<ALL> data members should be included in order for the generated I<clone> and I<swap> functions to function correctly. 
...
=item Class::STL::ClassMembers::FunctionMember::New

By including a constructed object of this type (via the new() function) in the import list for F<Class::STL::ClassMembers>, the F<new()> function will be produced for the I<caller> class.
